...
### Description, key features and technological used :
...
Then we made the utility functions so we could complete the main file.
Finally we made the Read Me so we could submit our work. 
